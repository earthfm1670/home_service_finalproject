...
//           </div>
//           <div className="flex flex-col py-6">
//             <label htmlFor="ชื่อบริการ">ค่าบริการ / 1 หน่วย</label>
//             <input
//               type="text"
//               // onChange={handleInputChange}
...
//           </div>
//           <div className="flex flex-col py-6">
//             <label htmlFor="ชื่อบริการ">หน่วยการบริการ</label>
//             <input
//               type="text"
//               // onChange={handleInputChange}
//               className="border border-gray-300 h-11 rounded-lg w-[240px] pl-10"
//             />
//           </div>
//           <h1 className="mt-14 active:text-[#FF6347] cursor-pointer">ลบรายการ</h1>
//         </div>
//       </>
//     );
//   }
